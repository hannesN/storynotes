...
public class SettingNoteInputMask extends InputMask {
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableValue modelTitleObserveValue = EMFEditProperties.value(ed, StorynotesPackage.Literals.SETTING_NOTE__NAME).observe(model);
		...
		IObservableValue modelDescriptionObserveValue = EMFEditProperties.value(ed, StorynotesPackage.Literals.SETTING_NOTE__DESCRIPTION).observe(model);
		...
		IObservableValue modelKindObserveValue = EMFEditProperties.value(ed, StorynotesPackage.Literals.SETTING_NOTE__KIND).observe(model);
